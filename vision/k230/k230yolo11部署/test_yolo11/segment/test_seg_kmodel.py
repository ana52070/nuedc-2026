...
def preprocess(image, input_width=320,input_height=320):
    """
...
def main():
    # 设置参数
    model_path = '../../runs/segment/train/weights/best.kmodel'  # 替换为你的 ONNX 模型路径
    ...
    mask=sim.get_output_tensor(1).to_numpy()
    # 后处理
    ...
    # 保存结果图像
    cv2.imwrite("kmodel_det_result.jpg", result_image)
    print("kmodel_det_result.jpg is saved!")
